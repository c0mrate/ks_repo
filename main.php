...
<head>
    <meta charset="utf-8">
    <title>ร้านค้าสวัสดิการ มหาวิทยาลัยเทคโนโลยีพระจอมเกล้าพระนครเหนือ</title>
...
<body>
    ...
    <script>
        function goBack() {
          ...
          if (url.includes("http://c0mrate.sytes.net/")) {
            ...
            while (!url.includes("http://c0mrate.sytes.net/")) {
              window.history.back();
